...
public class urlink4 : MonoBehaviour
{
    void FixedUpdate()
    {
        ...
        if (GlobalVariables_TCP_IP_client.robotBaseRotLink_UR3_j.Length > 1 && GlobalVariables_Main_Control.isAuto && GlobalVariables_TCP_IP_client.robotBaseRotLink_UR3_j[3] >= 0f)
        {
